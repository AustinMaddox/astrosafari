...
$lang = array_merge($lang, array(
	...
	'BOARD_DISABLED'		=> 'This board is currently disabled for maintenance.',
...
// BEGAN - Groups page mod
	'GROUPS_EXPLAIN'			=> 'View a listing and description of each usergroup.',
// ENDED - Groups page mod
	...
	'NEW_PM'					=> '<span style="color:#ff0000"><strong>%d</strong> new message</span>',
	'NEW_PMS'					=> '<span style="color:#ff0000"><strong>%d</strong> new messages</span>',
...
// BEGAN - Create New Topic action in nav.html
	...
	'NEW_TOPIC_EXPLAIN'			=> 'How do I create a new topic?',
...
// BEGAN - Ranks Page mod
	'RANKS'						=> 'Ranks',
	'RANKS_EXPLAIN'				=> 'View the breakdown of member ranks.',
...
// BEGAN - Search Self Topics mod
	'SEARCH_SELF_TOPICS'		=> 'Your topics',
// ENDED - Search Self Topics mod
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'We are sorry, but you are not authorized to use this feature. You may have just registered here and may need to participate more to be able to use this feature. Perhaps you should introduce yourself in the Member Introductions forum.',
...
$lang = array_merge($lang, array(
	'ANNIVERSARY_LIST'			=> 'Membership Anniversaries',
	'ANNIVERSARY_CONGRATS'		=> 'Congrats to',
...
$lang = array_merge($lang, array(
	...
	'YEARS_OF_MEMBERSHIP'	=> '%s has been a member for %d full years',
	'YEAR_OF_MEMBERSHIP'	=> '%s has been a member for %d full year',
...
$lang = array_merge($lang, array(
	'FIRST_POSTER_AVATAR_ALT'			=> '%s started this topic',
	'LAST_POSTER_TOPIC_AVATAR_ALT'		=> '%s is the last person to post in this topic',
	'LAST_POSTER_FORUM_AVATAR_ALT'		=> '%s is the last person to post in the %s forum',
));
...
$lang = array_merge($lang, array(
	...
	'GALLERY_OLD'			=> 'Old Gallery',
	'GALLERY_OLD_DESC'		=> 'The old gallery is going away soon!',
	'GALLERY_OLD_EXPLAIN'	=> 'Please harvest your photos from it and upload to the new gallery system ASAP before its too late.',
...
$lang = array_merge($lang, array(
	...
	'TOPICALITY_EXPLAIN'			=> 'Attribute of being of interest at the present time.',
