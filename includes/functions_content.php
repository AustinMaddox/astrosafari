...
// BEGAN - Changed to allow auto-detected links to open in new window
...
// ENDED - Changed to allow auto-detected links to open in new window
...
function get_username_string($mode, $user_id, $username, $username_colour = '', $guest_username = false, $custom_profile_url = false)
{
	...
	{
		$username .= '<img src="' . $phpbb_root_path . 'images/icons/icon_user_online_small.gif" alt="'. $username . ' is online!" />';
