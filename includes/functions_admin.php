...
// ENDED - Avatar of poster on Index and Viewforum mod
			...
			if (sizeof($post_ids))
			{
				$sql = 'SELECT p.post_id, p.poster_id, p.post_subject, p.post_time, p.post_username, u.username, u.user_colour, u.user_avatar, u.user_avatar_type, u.user_avatar_width, u.user_avatar_height
...
// ENDED - Avatar of poster on Index and Viewforum mod
			...
			// 6: Now do that thing
			$fieldnames = array('last_post_id', 'last_post_subject', 'last_post_time', 'last_poster_id', 'last_poster_name', 'last_poster_colour', 'last_poster_avatar', 'last_poster_avatar_type', 'last_poster_avatar_width', 'last_poster_avatar_height');
		...
		case 'topic':
			...
			$sql = 'SELECT p.post_id, p.topic_id, p.post_approved, p.poster_id, p.post_subject, p.post_username, p.post_time, u.username, u.user_colour, u.user_avatar, u.user_avatar_type, u.user_avatar_width, u.user_avatar_height
				FROM ' . POSTS_TABLE . ' p, ' . USERS_TABLE . ' u
				WHERE ' . $db->sql_in_set('p.post_id', $post_ids) . '
...
// ENDED - Avatar of poster on Index and Viewforum mod
			...
			$fieldnames = array('time', 'replies', 'replies_real', 'poster', 'first_post_id', 'first_poster_name', 'first_poster_colour', 'first_poster_avatar', 'first_poster_avatar_type', 'first_poster_avatar_width', 'first_poster_avatar_height', 'last_post_id', 'last_post_subject', 'last_post_time', 'last_poster_id', 'last_poster_name', 'last_poster_colour', 'last_poster_avatar', 'last_poster_avatar_type', 'last_poster_avatar_width', 'last_poster_avatar_height');
