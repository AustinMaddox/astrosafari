...
/* 
						* Fix for recount topic on large boards
						* Use this code when the "Resynchronise topic counts" times out and does not complete.
						* http://www.phpbb.com/customise/db/mod/nv_usertopics/support/fix_problem_with_large_forums-t_84136
