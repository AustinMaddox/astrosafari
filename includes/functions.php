...
// BEGAN - Disabled board points to another page
// http://www.astrosafari.com/ucp.php?mode=login&admin_key=true
/*
$admin_key = request_var('admin_key', '');
$testers = ($user->data['user_id'] == 1734 || $user->data['user_id'] == 6145) ? true : false;
if (!$testers)
{
	if( (($config['board_disable']) && (!$auth->acl_get('a_')) && $admin_key !== 'true') )
	{
		header ("Location: http://www.astrosafari.com/index.html");
	}
}
*/
// ENDED - Disabled board points to another page
...
// BEGAN - About Us Page mod
		'U_ABOUT'				=> append_sid("{$phpbb_root_path}about.$phpEx"),
// ENDED - About Us Page mod
...
// BEGAN - Groups Page mod
		'U_GROUPS'				=> append_sid("{$phpbb_root_path}groups.$phpEx"),
// ENDED - Groups Page mod
		'U_SEARCH'				=> append_sid("{$phpbb_root_path}search.$phpEx"),
		'U_REGISTER'			=> append_sid("{$phpbb_root_path}ucp.$phpEx", 'mode=register'),
		'U_PROFILE'				=> append_sid("{$phpbb_root_path}ucp.$phpEx"),
// BEGAN - Your Profile Link mod
		'U_YOUR_PROFILE'        => append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=viewprofile&amp;u=' . $user->data['user_id']),
...
// ENDED - mChat mod
// BEGAN - Ranks Page mod
		'U_RANKS'				=> append_sid("{$phpbb_root_path}ranks.$phpEx"),
// ENDED - Ranks Page mod
...
* This function originally came from the Friend List mod
*/
