...
$seo_meta->collect('description', $forum_data['forum_name'] . $extra_title . ': ' . (!empty($forum_data['forum_desc']) ? $forum_data['forum_desc'] : $seo_meta->meta_def['description']) . $extra_title );
...
// BEGAN - Avatar of poster on Index and Viewforum mod
		$avatar_max_dimensions = $topic_first_poster_avatar_width = $topic_first_poster_avatar_height = $topic_last_poster_avatar_width = $topic_last_poster_avatar_height = '';
		
		if ( !empty($row['topic_first_poster_avatar']) || !empty($row['topic_last_poster_avatar']))
		{
		$avatar_max_dimensions = 34; // here you can change the max-width you would like to have the avatars displayed
		...
		$topic_first_poster_avatar_alt = sprintf($user->lang['FIRST_POSTER_AVATAR_ALT'], $row['topic_first_poster_name']);
		$topic_last_poster_avatar_alt = sprintf($user->lang['LAST_POSTER_TOPIC_AVATAR_ALT'], $row['topic_last_poster_name']);
		
		$topic_author_avatar = get_user_avatar($row['topic_first_poster_avatar'], $row['topic_first_poster_avatar_type'], $topic_first_poster_avatar_width, $topic_first_poster_avatar_height, $topic_first_poster_avatar_alt);
		$last_post_author_avatar = get_user_avatar($row['topic_last_poster_avatar'], $row['topic_last_poster_avatar_type'], $topic_last_poster_avatar_width, $topic_last_poster_avatar_height, $topic_last_poster_avatar_alt);
...
// BEGAN - Avatar of poster on Index and Viewforum mod
			'TOPIC_AUTHOR_AVATAR'		=> ($config['enable_avatar_index'] && $topic_author_avatar) ? $topic_author_avatar : '<img src="images/no_avatar_30x30.gif" alt="' . $user->lang['NO_AVATAR'] . '" title="' . $topic_first_poster_avatar_alt . '" />',
// ENDED - Avatar of poster on Index and Viewforum mod
			...
			'LAST_POST_AUTHOR_FULL_ADVERTISEMENT' =>  get_username_string('full', 9603, 'AstroSafari.com'),
// BEGAN - Avatar of poster on Index and Viewforum mod
			'LAST_POST_AUTHOR_AVATAR'	=> ($config['enable_avatar_index'] && $last_post_author_avatar) ? $last_post_author_avatar : false,
...
// ENDED - Avatar of poster on Index and Viewforum mod
			...
			'REPLIES'			=> $replies,
			'REPLIES_ADVERTISEMENT' => rand(5,10),
			'VIEWS'				=> $row['topic_views'],
			'VIEWS_ADVERTISEMENT' => rand(10,100),
